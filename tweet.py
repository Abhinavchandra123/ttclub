            ...
            while True:
                ...
                try:
                    engagement_elements = wait.until(
                        EC.presence_of_all_elements_located(
                            (By.CSS_SELECTOR, 'a[role="link"][aria-label*="views"]')
                        )
                    )
                except Exception as e:
                    print("cant find views")
                    # If the elements are not found, assign False to engagement_elements
                    engagement_elements = False
