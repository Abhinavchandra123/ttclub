        ...
        try:
            ...
            try:
                while attempt_count < max_attempts:               
                    ...
                    try:
    # Check if at least one tweet is visible within a certain time frame
                        tweets = wait.until(EC.visibility_of_element_located((By.XPATH, '//div[@data-testid="tweetText"]')))
