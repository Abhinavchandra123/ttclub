    ...
    for topic_name in search_by:
        try:
            ...
            while True:
                ...
                for username, tweet, like_element, engagement_element, href_element, reply, repost in zip(
                    usernames, tweets, like_elements, engagement_elements, hrefs, replies, reposts
                ):
                    user_full_name = (
